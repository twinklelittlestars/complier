...
{
  "\"end of file\"", "error", "\"invalid token\"", "OR", "STAR", "LPAREN",
  "RPAREN", "CHARACTER", "$accept", "expression", "term", "factor", YY_NULLPTR
};
...
{
       9,     7,     8,    12,     8,    11,     6,     1,     9,     2,
      10
};

static const yytype_int8 yycheck[] =
{
       4,     0,     3,     8,     3,     6,     1,     5,    12,     7,
       4
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* expression: expression OR term  */
#line 53 "NFA.y"
                         { (yyval.nfa) = unionNFA((yyvsp[-2].nfa), (yyvsp[0].nfa)); EndNFA = (yyval.nfa);}
#line 1159 "y.tab.c"
    break;

  case 3: /* expression: term  */
#line 54 "NFA.y"
                         { (yyval.nfa) = (yyvsp[0].nfa);EndNFA = (yyval.nfa); }
#line 1165 "y.tab.c"
    break;

  case 4: /* term: term factor  */
#line 58 "NFA.y"
                         { (yyval.nfa) = concatenateNFA((yyvsp[-1].nfa), (yyvsp[0].nfa)); }
#line 1171 "y.tab.c"
    break;
...
#line 1177 "y.tab.c"
  ...
  case 6: /* factor: CHARACTER  */
#line 63 "NFA.y"
                              { (yyval.nfa) = singleCharNFA((yyvsp[0].character)); }
#line 1183 "y.tab.c"
    break;

  case 7: /* factor: factor STAR  */
#line 64 "NFA.y"
                          { (yyval.nfa) = kleeneStarNFA((yyvsp[-1].nfa)); }
#line 1189 "y.tab.c"
    break;
